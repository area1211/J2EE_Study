...
/**
 * Servlet implementation class MemberListForManagerServ
 */
public class MemberListForManagerServ extends HttpServlet {
...
//		request.setAttribute("p_list", subList);
		...
		RequestDispatcher view = request.getRequestDispatcher("memberlist_for_manager.jsp");
