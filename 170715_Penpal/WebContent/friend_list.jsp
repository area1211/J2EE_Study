...
<body>
 <h2>나의 친구</h2>
   ...
   <tr>
      ...
      이름:${bookmark[0]}  
      <br>나이:${bookmark[1]}  <br>성별:${bookmark[2]}  <br>국적:${bookmark[3]}  
      <br>
   언어:${bookmark[7]}<br>
   친구추가일:${bookmark[8]}<br>  
   연락회수:${bookmark[9]}<br>
      ...
      <td>
      <li style="list-style-type:none"><img width="90px" height="30px" src="images/mailSend.JPG"/></li>
      <li style="list-style-type:none"><img width="90px" height="30px" src="images/friendDis.JPG"/></li>
      </td>
    </tr>
  </c:forEach>
