...
<link rel="stylesheet" href="stylesheet/profile_search_result.css" />
<script src="js/profile_search_result.js"></script>
...
<body>
   ...
   <tr>
    ...
    <tr>
      <td class="imageVideo">
      	<video id="iv1" name="iv1" width="200px" height="110px" src="./videos/악녀.mp4" type="video/mp4" onClick="hi()" />
      </td>
      <td class="textTd">
